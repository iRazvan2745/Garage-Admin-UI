...
export default function AddKeyToBucketDialog({ bucketId, accessKeyId, open, onOpenChange, afterAllow }: AddKeyToBucketDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleAllow} disabled={loading || (!read && !write && !owner)}>
